const TEXTEDITOR_COMMON_STYLES = 'uppercase rounded border-2 border-blue-300  dark:text-white';

const TEXTEDITOR_FORM_FIELDS_STYLES = `${TEXTEDITOR_COMMON_STYLES} dark:bg-gray-900`

export const TEXTEDITOR_SLUGLINE_STYLE = `${TEXTEDITOR_FORM_FIELDS_STYLES} px-3`;
